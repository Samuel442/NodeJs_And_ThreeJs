...
var objLoader_arm;
var robo_arm;
function carrega_componente_arm()
{
  // Load the OBJ file with its MTL materials
  objLoader_arm = new OBJLoader();
objLoader_arm.load('arm.obj', function (obj) {
// Add the loaded object to the scene
robo_arm = obj.scene;                          // objeto recebe a cena
objLoader_arm.position.set(0, 0, 0);
scene.add(obj);
});
}
