...
renderer.setSize(window.innerWidth, window.innerHeight); // seta o tamanho, largura e altura
document.body.appendChild(renderer.domElement);          // adiciona um elemento dentro do corpo do documento html


// geometria de capsula
const geometry = new THREE.CapsuleGeometry(1,
                                           1, 
                                           4,
                                           8);
// material
const material = new THREE.MeshBasicMaterial({color: 0x00ff00, // cor do objeto
                                              wireframe: true, // textura em arame
}); 
